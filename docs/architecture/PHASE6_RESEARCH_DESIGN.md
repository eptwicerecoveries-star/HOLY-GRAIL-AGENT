...
**Not in this slice:** ArcGIS, ConfigurableREST / generic REST, county-specific provider classes, a verified live dataset, opt-in live tests. NYC PLUTO (`data.cityofnewyork.us` / `64uk-42ks`) is a leading first-live candidate only. No PLUTO live request has occurred. No live provider has been enabled.
