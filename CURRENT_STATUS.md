...
| 6 | Research & Enrichment | **6A–6E COMPLETE; Phase 6F COMPLETE FOR OFFLINE/CORE V1** | Core research/enrichment/skip-trace offline path complete. **P1:** COMPLETE. **P2:** COMPLETE FOR LOCAL READ-ONLY V1. **P3:** COMPLETE FOR LOCAL AUTHENTICATED V1. **P4-A:** COMPLETE. **P4-B:** IN PROGRESS (**P4-B1** COMPLETE; **P4-B2-A** throttle foundation; **P4-B2-B/P4-B3** NOT STARTED). **P4-C:** NOT STARTED. Still **127.0.0.1** only — **NOT** internet-ready. |
...
**P4-B2-A (this increment):** THROTTLE DATA/SERVICE FOUNDATION IMPLEMENTED/TESTED — `login_throttle_buckets` table + `surplus_ai/auth/login_throttle.py` service (IP attempt gate + credential failure buckets). **Does not change HTTP login behavior.** No 429/Retry-After until P4-B2-B.

**P4-B2-B:** NOT STARTED (login route HTTP integration).
