...
| 6 | Research & Enrichment | **6A–6E COMPLETE; Phase 6F COMPLETE FOR OFFLINE/CORE V1** | Core research/enrichment/skip-trace offline path complete. **P1:** COMPLETE. **P2:** COMPLETE FOR LOCAL READ-ONLY V1. **P3:** COMPLETE FOR LOCAL AUTHENTICATED V1. **P4-A:** COMPLETE. **P4-B:** IN PROGRESS (**P4-B1** Origin + Trusted Host; **P4-B2/P4-B3** NOT STARTED). **P4-C:** NOT STARTED. Still **127.0.0.1** only — **NOT** internet-ready. |
...
**P4-B2:** NOT STARTED (login throttling — design not locked).
